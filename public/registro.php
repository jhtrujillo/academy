...
<head>
    ...
    <title>Crear Cuenta | Academy Dojo</title>
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <h2 class="auth-title">Únete al Dojo 🥋</h2>
            <p class="auth-subtitle">Regístrate para empezar tu formación de Growth Partner.</p>
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <i class="lucide-user input-icon"></i>
                        <input class="form-input" type="text" id="nombre" name="nombre" placeholder="Juan Pérez" required>
                    </div>
                </div>
            ...
            <a href="/login.php" class="auth-link">¿Ya tienes una cuenta? <strong>Inicia sesión aquí</strong></a>
        </div>
    </div>
